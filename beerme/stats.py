...
def get_stats():
    ...
    generate_beer_type_histogram(last_five_beers_df,BEER_TYPES_HIST_IMAGE_NAME)

    BEER_RATINGS_HIST_IMAGE_NAME=f"{g.user['username']}_beer_ratings_plot.png"
    generate_beer_ratings_histogram(last_five_beers_df,BEER_RATINGS_HIST_IMAGE_NAME)
...
def generate_beer_type_histogram(dataframe,IMAGE_NAME):
    ...
    IMG_PATH=os.path.join(root_dir, 'BeerMe', 'beerme', 'static', f'{IMAGE_NAME}')
    plt.clf()
